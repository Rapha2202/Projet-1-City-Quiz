const questions = [
    {
        "id": 1,
        "questiontxt": "Au foot ⚽️, quelle équipe Française a gagné le plus de Ligue 1 ?",
        ...
        "repv": ["answer4"],
        "info": "C'est bien le Paris Saint-Germain qui en a gagné le plus, avec un total de 11 Ligue 1 suivi de près par Saint-Étienne qui en a gagné 10."
    },
    {
        "id": 2,
        ...
        "answer4": "6 formes",
        "repv": ["answer3"],
        "info": "Il y a bien 5 formes différentes, Freezer 1ere, 2eme, 3eme forme, Freezer forme finale et Mecha Freezer."
    },
    {
        "id": 3,
        "questiontxt": "Par quelle entreprise le jeu vidéo Minecraft a-t-il été racheté en 2014 ? 👾",
    ...
    },
    {
        ...
        "answer4": "Ou bien ici",
        "repv": ["answer1"],
        "info": "Petite question piège ! 🤪"
    },
    {
        "id": 5,
        "questiontxt": "Dans Pokemon, lequel d'entre eux possède la meilleure VF ? 🗣️",
    ...
    {
        "id": 6,
        "questiontxt": "Dans quelle discipline ne trouve t-on pas de Kata ? 🤼‍♂️",
    ...
    {
        "id": 9,
        "questiontxt": "Dans 'Dragon Ball', sur quelle île se déroule les championnats du monde d'arts martiaux ? 🏝️",
        ...
        "answer4": "L'île Blue",
        "repv": ["answer1"],
        "info": "C'est bien l'île Papaya ! ...le savais-tu ? Cette île ne possède aucune autre saison que l'été, son climat est doux et chaud en permanence."
    },
    {
        "id": 10,
        "questiontxt": "Dans Hunter x Hunter, que représente les numeros de la Brigade Fantôme ? 👻",
        ...
        "repv": ["answer1"],
        "info": "Il y a en bien 12 membres comme le nombre de mois dans une année."
    },
    {
        "id": 11,
        ...
        "repv": ["answer4"],
        "info": "Et oui ! Le jeu a changé de nom pour s'appeler EA Sports FC 24."
    },
    {
        "id": 12,
        "questiontxt": "Quelle est la date du décès de Michael Jackson ? 🕺",
    ...
    {
        "id": 13,
        "questiontxt": "Au catch, Undertaker fait une gimmick lors de son entrée. Quelle est-elle ? 🤼",
    ...
    {
        "id": 14,
        "questiontxt": "Dans Bocchi The Rock, quel est le problème de l'héroine ? (U ω U❁)",
        ...
        "repv": ["answer1", "answer4"],
        "info": "Elle a en effet 2 problèmes, elle s'imagine être harcelé et elle est extremement timide."
    },
    {
        "id": 15,
    ...
    {
        "id": 16,
        "questiontxt": "Parmis ces Mike, lequel a composé la musique de l'Éxorciste ? 🎃",
        ...
        "repv": ["answer3"],
        "info": "C'est bien Mike Oldfield qui a composé la musique de l'Éxorciste."
    },
    {
        "id": 17,
        "questiontxt": "Dans l'animé Sword Art Online, comment s'appel le système qui entretien le Jeux Vidéo dans lequel le héro est bloqué ? ⚔️",
        ...
        "answer4": "Yggdrasil",
        "repv": ["answer1"],
        "info": "Le système porte bien le nom de Carbinal, et le monde virtuel de la saison 1 est l'Aincrad que tu peux voir affiché ici."
    },
    {
        "id": 18,
    ...
    },
    {
        ...
        "answer4": "Noyade",
        "repv": ["answer2"],
        "info": "Meruem est bien mort de l'incecticide contenu dans la bombe nucléaire donc logiquement ce n'est pas la bombe qui l'a tué."
    },
    {
        "id": 20,
        ...
        "answer2": "Le Thousand Sunny (ça brille)",
        "answer3": "Oro Jackson (avec roger vivant)",
        "answer4": "Red Force gitanos",
        "repv": ["answer1"],
        "info": "Et oui le meilleur bâteau reste le Vogue Merry"
    }
]
...
goodNumber.innerHTML = `0 réponse ✅ sur ${questions.length}`
        ...
        if(name.toLowerCase() === "sacod"){
            ...
            for (let i = 0; i < questions[runningQuestion].repv.length; i++) {
                ...
                if (numberGoodAnswer > 1) {
                    goodNumber.innerHTML = `${numberGoodAnswer} réponses ✅ sur ${questions.length}`
                } else {
                    goodNumber.innerHTML = `${numberGoodAnswer} réponse ✅ sur ${questions.length}`
                }
